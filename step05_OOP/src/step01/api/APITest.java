...
public class APITest {
	...
	//문자열의 첫번째 음절의 데이터만 반환 - String - charAt(index)
	//두개의 숫자를 제공하면서 최대값 반환 - Math.max(숫자,숫자)
	//문자열의 길이를 반환 - String - name.length()
	/* String
	 * 길이를 반환 : 반환 -
	 * public int length(){
	 * 		이 메소드를 보유한 해당 객체의 문자열의 길이를 반환
	 * }
	 * 
	 */
	public static void main(String[] args) {
		...
		String v = "3";
	//	String v = "삼"; - Integer.ParseInt(String)
